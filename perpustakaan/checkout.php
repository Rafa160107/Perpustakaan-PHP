<?php 
    ...
    if(count($cart)>0){
        ...
        foreach ($cart as $key_produk => $val_produk) {
            mysqli_query($koneksi,"insert into detail_peminjaman_buku (id_peminjaman_buku,id_buku,qty) value('".$id_detail_peminjaman_buku."','".$val_produk['id_buku']."','".$val_produk['qty']."')");
        }
        unset($_SESSION['cart']);
